...
'''
This is a program from Fundamental investing tutorial (pythonprogramming.net) that looks for US companies following some criteria and graphs their data.
1. access yahoo finance to look for certain indicators such pe/g, pbratio, etc. of a given list of US companies 
2. If  a company meets the criteria, it's data is requested from quandl (api auth token not verified!)
3. Data is shown in a figure
'''
